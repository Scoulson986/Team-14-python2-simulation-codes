...
class SimulationAssignment():
  ...
  def get_line_camera_error(self, image0, image1, oldresult) -> float:
  ...
  def control_loop(self, vr: Any, car: Car, csvfile: Optional[SimpleCsvDictWriter]) -> None:
    ...
    line0_err = self.get_line_camera_error(self.oldimage, car.get_line_camera_image(0),  self.old_lat_err)
